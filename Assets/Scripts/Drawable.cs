...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        public void MarkPixelsToColour(Vector2 center_pixel, int pen_thickness, Color color_of_pen, Vector2[] Grid)
        {
            // Figure out how many pixels we need to colour in each direction (x and y)
            int center_x = (int)center_pixel.x;
            int center_y = (int)center_pixel.y;
            ...
            {
                MarkPixelToChange(center_x - (int)Grid[i].x, center_y - (int)Grid[i].y, color_of_pen);
            }
